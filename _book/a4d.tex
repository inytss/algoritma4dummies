...
\item
  ...
  \end{itemize}
\item
  Student tidak diperkenankan untuk mengerjakan quiz diluar waktu yang ditentukan. Student yang mengerjakan quiz diluar waktu yang ditentukan \textbf{tidak akan diberikan nilai} atau akan diberikan nilai 0.
\item
...
\item
  Student yang mengganti akun Github / username Github tanpa menginformasikan kepada tim mentor \textbf{tidak akan diberikan nilai} dan akan langsung diberikan nilai 0.
\end{itemize}
