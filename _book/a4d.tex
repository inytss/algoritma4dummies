...
\midrule
\endhead
\href{https://corgi.re/courses/ttnsy/quiz_PYW1}{Python for Data Analytics (P4DA)} & 6 \\
\href{https://corgi.re/courses/ttnsy/quiz_PYW2}{Exploratory Data Analysis (EDA)} & 6 \\
\href{https://corgi.re/courses/ttnsy/quiz_PYW3}{Data Wrangling \& Visualization (DWV)} & 6 \\
\href{https://corgi.re/courses/ttnsy/quiz_PYW4}{SQL Query} & 6 \\
\bottomrule
\end{longtable}
...
\midrule
\endhead
\href{https://corgi.re/courses/Davidlimbong/P4DS-PS}{Programming for Data Science - Practical Statistics (P4DS-PS)} & 4 \\
\href{https://corgi.re/courses/Argaadya/data-visualization}{Data Visualization (DV)} & 2 \\
\href{https://corgi.re/courses/Davidlimbong/InteractivePlotting}{Interactive Plotting (IP)} & 1 \\
\bottomrule
\end{longtable}
...
\endhead
\href{https://corgi.re/courses/Davidlimbong/P4DS-PS}{Programming for Data Science - Practical Statistics (P4DS-PS)} & 4 \\
\href{https://corgi.re/courses/ahmadhusain/regressionmodels}{Regression Model (RM)} & 4 \\
\href{https://corgi.re/courses/inytss/classification1}{Classification in Machine Learning I (C1)} & 4 \\
\href{https://corgi.re/courses/ysitta/Classification2}{Classification in Machine Learning II (C2)} & 4 \\
\href{https://corgi.re/courses/Davidlimbong/UnsupervisedLearning}{Unsupervised Learning (UL)} & 4 \\
\href{https://corgi.re/courses/inytss/time-series}{Time Series and Forecasting (TS)} & 4 \\
\href{https://corgi.re/courses/ysitta/Neural_Network}{Neural Network (NN)} & 4 \\
\bottomrule
\end{longtable}
...
\item
  File \texttt{.Rmd} atau \texttt{.ipynb} dapat dikirimkan pada google classroom melalui \emph{assignment} quiz bagi student yang merasa \textbf{terdapat kekeliruan pengisian} \href{https://corgi.re}{corgi.re}.
\end{itemize}
