...
\item
  Teaching team saling memberikan masukan untuk perbaikan kelas.
\end{itemize}
...
Berikut ini link quiz pada \href{https://algoritmaonline.com}{algoritmaonline.com}:

\textbf{Data Analytics Specialization}

\begin{longtable}[]{@{}cc@{}}
\toprule
\textbf{Link} & \textbf{Maksimal Nilai} \\
\midrule
\endhead
\href{https://algoritmaonline.com/quizzes/python-for-data-analysts-p4da-quiz/}{Python for Data Analytics (P4DA)} & 6 \\
\href{https://algoritmaonline.com/quizzes/exploratory-data-analysis-eda-quiz/}{Exploratory Data Analysis (EDA)} & 6 \\
\href{https://algoritmaonline.com/quizzes/data-wrangling-and-visualization-dwv-quiz/}{Data Wrangling \& Visualization (DWV)} & 6 \\
\href{https://algoritmaonline.com/quizzes/sql-query-quiz/}{SQL Query} & 6 \\
\bottomrule
\end{longtable}
...
\midrule
\endhead
\href{https://algoritmaonline.com/quizzes/practical-statistics-for-data-science/}{Programming for Data Science - Practical Statistics (P4DS-PS) Version 1} & 4 \\
\href{https://algoritmaonline.com/quizzes/data-visualization-quiz/}{Data Visualization (DV) Version 1} & 2 \\
\href{https://algoritmaonline.com/quizzes/interactive-plotting-quiz/}{Interactive Plotting (IP) Version 1} & 1 \\
\bottomrule
\end{longtable}
...
\midrule
\endhead
\href{https://corgi.re/courses/Davidlimbong/P4DS-PS}{Programming for Data Science - Practical Statistics (P4DS-PS) Version 1} & 4 \\
\href{https://algoritmaonline.com/quizzes/regression-model-quiz/}{Regression Model (RM) Version 2} & 4 \\
\href{https://algoritmaonline.com/quizzes/classification-1-quiz/}{Classification in Machine Learning I (C1) Version 2} & 4 \\
\href{https://algoritmaonline.com/quizzes/classification-2-quiz/}{Classification in Machine Learning II (C2)} & 4 \\
\href{https://algoritmaonline.com/quizzes/unsupervised-learning-quiz/}{Unsupervised Learning (UL) Version 2} & 4 \\
\href{https://algoritmaonline.com/quizzes/time-series-quiz/}{Time Series and Forecasting (TS) Version 2} & 4 \\
\href{https://algoritmaonline.com/quizzes/neural-network-quiz/}{Neural Network (NN) Version 2} & 4 \\
\bottomrule
\end{longtable}

\begin{quote}
Kunci jawaban dari setiap quiz dapat diakses pada \href{https://drive.google.com/drive/folders/11wfxZ6DN2IVECOQNuKRN7ernT4ptKdev?usp=sharing}{drive \textbf{quiz keys}}
\end{quote}
...
\item
  Quiz dikerjakan melalui platform \href{https://algoritmaonline.com}{algoritmaonline.com} dengan menggunakan akun Algoritm ONline yang sudah teregistrasi.
\item
  File \texttt{.Rmd} atau \texttt{.ipynb} dapat dikirimkan pada google classroom melalui \emph{assignment} quiz bagi student yang merasa \textbf{terdapat kekeliruan pengisian} \href{https://algoritmaonline.com}{algoritmaonline.com}.
\end{itemize}
...
\item
  Pelaksanaan quiz susulan dilakukan 2-3 hari setelah \emph{briefing} Capstone Project dari setiap spesialisasi pada pukul 18.30 - 20:30 WIB.
\item
...
\item
  ...
  \tightlist
  \item
    Fase 1: LBB P4DS, DV maksimal dikumpulkan 1 minggu setelah deadline Capstone Project Data Visualization.
  \item
...
\begin{quote}
Pengumpulan LBB IP tetap seperti biasa yaitu diberikan waktu 1 minggu pengerjaan.
\end{quote}

\begin{itemize}
\tightlist
\item
  Student yang terlambat mengumpulkan LBB tidak mendapat pengurangan nilai kecuali LBB IP; yaitu keterlambatan akan dikenakan \textbf{pengurangan nilai 1 poin}.
\item
...
\item
  Bagi student yang ingin mendapatkan career support \textbf{wajib} mengumpulkan LBB dengan detail jumlah LBB yang harus dikumpulkan dapat dilihat pada \href{https://algoritma4dummies.netlify.app/data-career-day-dcd.html\#the-day-dcd}{\textbf{Chapter 5 Data Career Day (DCD)}}.
\end{itemize}
...
\item
  Selama di kelas, student akan diberikan capaian tugas yang harus dikerjakan dan dikumpulkan pada google classroom pada hari yang sama saat briefing capstone project.
\item
...
\begin{quote}
Note: Pengumpulan \textbf{capstone ML} dianggap sah ketika student mengumpulkan file dalam bentuk \textbf{html}, apabila tidak maka Product team berhak untuk mengembalikan pekerjaan student dan tidak akan dikoreksi terlebih dahulu. Apabila student mengumpulkan file html dan \textbf{telah lewat deadline pengumpulan capstone}, maka pengumpulan capstone akan \textbf{dianggap terlambat}.
\end{quote}
...
\begin{quote}
Note: Pinalti diatas dihitung berdasarkan hari kerja
\end{quote}
...
\item
  Setiap pertanyaan terkait eror, mentoring, dan pertanyaan umum tim piket tidak perlu memberikan \emph{first response} dikarenakan sistem akan melakukan \emph{automated first response}.
\item
  Tiket yang telah masuk diharapkan dapat memperoleh jawaban mengenai isi tiket maksimal \textbf{2 jam} setelah tiket tersebut diterima.
\item
...
\item
  Setiap tim piket dalam memberikan feedback LBB harus mengacu pada rubrik masing-masing LBB.
\end{itemize}

\begin{quote}
Note: Detail rubrik masing-masing LBB pada \textbf{Data Visualization Specialization} dan \textbf{Machine Learning Specialization} dapat dilihat pada \href{https://rpubs.com/AlgoritmaAcademy/lbb}{guidelines LBB} dan \href{https://docs.google.com/document/d/117LRRFF0jLR5SQku3PYkUggst06Vj9XfNahcK5oJYHs/edit?usp=sharing}{LBB rubrics}.
\end{quote}
