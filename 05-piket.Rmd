...
* Panduan dalam merespon email dengan baik dan benar dapat dilihat pada [dokumentasi berikut](https://trello-attachments.s3.amazonaws.com/5b178a5917d78094e809e4c9/5f69df1f8aa3e54171468888/de3bd28e0177e532a9de032b35310397/guidelines_(5).html)
* Setiap pertanyaan terkait eror, mentoring, dan pertanyaan umum tim piket tidak perlu memberikan *first response* dikarenakan sistem akan melakukan *automated first response*.
* Tiket yang telah masuk diharapkan dapat memperoleh jawaban mengenai isi tiket maksimal **2 jam** setelah tiket tersebut diterima.
...
> Note: Detail rubrik masing-masing LBB pada **Data Visualization Specialization** dan **Machine Learning Specialization** dapat dilihat pada [guidelines LBB](https://rpubs.com/AlgoritmaAcademy/lbb) dan [LBB rubrics](https://docs.google.com/document/d/117LRRFF0jLR5SQku3PYkUggst06Vj9XfNahcK5oJYHs/edit?usp=sharing).
...
Apabila membutuhkan bantuan mentor, Anda dapat mengajukan pertanyaan melalui email mentor@algorit.ma.
