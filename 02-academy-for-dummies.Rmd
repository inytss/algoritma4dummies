...
* Khusus saat academy akan berlangsung, **PIC academy** mengirimkan informasi pengenai pre-workshop handbook serta pre-class requirement yang dapat diakses link nya pada bagian [**Reference**](http://127.0.0.1:46600/rmd_output/0/references.html).
...
<center> **Data Analytics Specialization** </center>
...
<center> **Data Visualization Specialization** </center>
...
<center> **Machine Learning Specialization** </center>
...
* Student tidak diperkenankan untuk mengerjakan quiz diluar waktu yang ditentukan. Student yang mengerjakan quiz diluar waktu yang ditentukan **tidak akan diberikan nilai** atau akan diberikan nilai 0.
...
* Student yang mengganti akun Github / username Github tanpa menginformasikan kepada tim mentor **tidak akan diberikan nilai** dan akan langsung diberikan nilai 0.
...
* Bagi student yang ingin mendapatkan career support **wajib** mengumpulkan LBB dengan detail banyaknya LBB yang harus dikumpulkan dapat dilihat pada [**Chapter 5 Data Career Day (DCD)**](http://127.0.0.1:46600/rmd_output/0/data-career-day-dcd.html#pre-requisite-data-career-day).
