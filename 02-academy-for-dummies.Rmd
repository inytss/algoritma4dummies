...
Berikut ini link quiz pada [algoritmaonline.com](https://algoritmaonline.com):
...
|                                     **Link**                                     | **Maksimal Nilai** |
|:--------------------------------------------------------------------------------:|:------------------:|
|   [Python for Data Analytics (P4DA)](https://algoritmaonline.com/quizzes/python-for-data-analysts-p4da-quiz/)   |          6         |
|    [Exploratory Data Analysis (EDA)](https://algoritmaonline.com/quizzes/exploratory-data-analysis-eda-quiz/)   |          6         |
| [Data Wrangling & Visualization (DWV)](https://algoritmaonline.com/quizzes/data-wrangling-and-visualization-dwv-quiz/) |          6         |
|               [SQL Query](https://algoritmaonline.com/quizzes/sql-query-quiz/)              |          6         |
...
|                                     **Link**                                     | **Maksimal Nilai** |
|:--------------------------------------------------------------------------------:|:------------------:|
|   [Programming for Data Science - Practical Statistics (P4DS-PS) Version 1](https://algoritmaonline.com/quizzes/practical-statistics-for-data-science/)   |          4         |
|    [Data Visualization (DV) Version 1](https://algoritmaonline.com/quizzes/data-visualization-quiz/)  |          2         |
| [Interactive Plotting (IP) Version 1](https://algoritmaonline.com/quizzes/interactive-plotting-quiz/) |          1         |
...
|                                                    **Link**                                                    | **Maksimal Nilai** |
|:--------------------------------------------------------------------------------------------------------------:|:------------------:|
| [Programming for Data Science - Practical Statistics (P4DS-PS) Version 1](https://corgi.re/courses/Davidlimbong/P4DS-PS) |          4         |
|                 [Regression Model (RM) Version 2](https://algoritmaonline.com/quizzes/regression-model-quiz/)                 |          4         |
|          [Classification in Machine Learning I (C1) Version 2](https://algoritmaonline.com/quizzes/classification-1-quiz/)          |          4         |
|          [Classification in Machine Learning II (C2)](https://algoritmaonline.com/quizzes/classification-2-quiz/)         |          4         |
|            [Unsupervised Learning (UL) Version 2](https://algoritmaonline.com/quizzes/unsupervised-learning-quiz/)            |          4         |
|                 [Time Series and Forecasting (TS) Version 2](https://algoritmaonline.com/quizzes/time-series-quiz/)                |          4         |
|                      [Neural Network (NN) Version 2](https://algoritmaonline.com/quizzes/neural-network-quiz/)                     |          4         |

> Kunci jawaban dari setiap quiz dapat diakses pada [drive **quiz keys**](https://drive.google.com/drive/folders/11wfxZ6DN2IVECOQNuKRN7ernT4ptKdev?usp=sharing)
...
* Quiz dikerjakan melalui platform [algoritmaonline.com](https://algoritmaonline.com) dengan menggunakan akun Algoritm ONline yang sudah teregistrasi.
* File `.Rmd` atau `.ipynb` dapat dikirimkan pada google classroom melalui *assignment* quiz bagi student yang merasa **terdapat kekeliruan pengisian** [algoritmaonline.com](https://algoritmaonline.com). 
...
* Pelaksanaan quiz susulan dilakukan 2-3 hari setelah *briefing* Capstone Project dari setiap spesialisasi pada pukul 18.30 - 20:30 WIB.
...
Detail rubrik masing-masing LBB pada **Data Visualization Specialization** dan **Machine Learning Specialization** dapat dilihat pada [guidelines LBB](https://rpubs.com/AlgoritmaAcademy/lbb) dan [LBB rubrics](https://docs.google.com/document/d/117LRRFF0jLR5SQku3PYkUggst06Vj9XfNahcK5oJYHs/edit?usp=sharing).
...
* Student yang terlambat mengumpulkan LBB tidak mendapat pengurangan nilai kecuali LBB IP; yaitu keterlambatan akan dikenakan **pengurangan nilai 1 poin**.
...
* Bagi student yang ingin mendapatkan career support **wajib** mengumpulkan LBB dengan detail jumlah LBB yang harus dikumpulkan dapat dilihat pada [**Chapter 5 Data Career Day (DCD)**](https://algoritma4dummies.netlify.app/data-career-day-dcd.html#the-day-dcd).
...
> Note: Pengumpulan **capstone ML** dianggap sah ketika student mengumpulkan file dalam bentuk **html**, apabila tidak maka Product team berhak untuk mengembalikan pekerjaan student dan tidak akan dikoreksi terlebih dahulu. Apabila student mengumpulkan file html dan **telah lewat deadline pengumpulan capstone**, maka pengumpulan capstone akan **dianggap terlambat**.
...
* Student yang mengalami **keterlambatan pengumpulan capstone** serta **nilainya dibawah batas nilai perbaikan** dapat melakukan perbaikan capstone sebanyak **1 kali** dengan batas pengumpulan **1 minggu** (hari kerja dan hari libur) sejak pemberian *feedback* dan akan mendapat nilai maksiimal 80% dari total nilai.
